...
this assumption with an appropriate stationarity/ergodicity assumption, with no real change
...
point, Dan, don't forget to write a caption for the Theory fig and make sure all the technical stuff on 
surrogates gets put in right sup mat section and notation gets adjusted to match with the notation we 
have been using-->
...
\caption{Dan to fill in. \label{fig_theory}}
\end{center}
\end{figure}
<!--***DAN: Don't forget to write this caption, Dan.-->
