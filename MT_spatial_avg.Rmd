...
pair-wise inter-specific interactions possible. First, for each of these species-pairs, we
...
$S_{ind} = \sum_{i}m_{iii}/\sum_{i}v_{i}^{3/2}$. Therefore, we define the 
skewness-based stability index $\phi_{s} = S_{com}/ S_{ind}$ similar to that 
...
interspefic interactions alter the skewness (i.e. changing its sign) of a community-biomass 
distribution over years than it would have been without any interactions. 

<!--Episodic species may 
cause this scenario by its occasional but high abundance. 
***Shya:please review this line, am I right here?
Don't say about episodic species, rather give intuitively the example about left tail dep. community with slightly right skewed marginals will produce phi_s<0.
-->
...
due to tail association between interspecific response, as follows. 
