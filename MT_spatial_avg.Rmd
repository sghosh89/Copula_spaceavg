...
an approach to studying the relationships
between species that complements classic approaches relying on covariances. (G2) We will also develop an
...
<!--***DAN: Dan made it to here 2020 06 16, 1120am. Need to stop for now. In addition to continuing from this
point, Dan, don't forget to write all the technical stuff in three sup mat sections before moving on-->
