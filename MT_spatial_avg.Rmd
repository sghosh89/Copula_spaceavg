...
***Shya: done.-->
<!--***DAN: Now the table and the text disagree in the last digit. I gather this is because you rounded in one place and 
truncated in the other, or somethinbg like that. Of course you know that values that appear in two places in a manuscript
should be the same, or if they differ it should be because one is a rounded (not truncated) version of the other. Please 
make values the same, not only here but everywhere. Please make all values agree with the *accurate* answer. I gather from your
earlier comment that perhaps the values in the figures were based on doing math with intermediate stages rounded or truncated.
This is not the correct way to do it. You round at the end of a computation, typically, not in the middle. Please fix,
here and everwhere that similar problems occur. I would like for the next version I look at, please, to have the same,
and correct, numbers whenever the same result is reported twice, please. I would prefer to not have to revisit this issue
again. Thanks!-->
...
<!--***DAN: Shyamolina, please make the above number an autolink
***Shya: done.-->
<!--***DAN: The values now disagree in the last digit, please fix.-->
...
***DAN: Please fix this. Of course we cannot have the same number reported in two places being different. Please make the
figures (all of them, not just this one we are currently talking about) use the full values for all computations, just the
in the same way as is done for the tables. Values should be rounded, please (not truncated) to the same number of 
significant figures wherever they appear.-->
