...
Thus $\CVcomsq=\phi_{\text{cv}} \CVindsq$. Because $\CVindsq$ is in sinterpreted as what community variability would be, without species interactions,
...
[@bai2004ecosystem;@houlahan2007;@hallett2014]. Evidence so far suggests that synchonous dynamics may be dominant
...
and identically distributed for distinct times, $t$. It should be straighforward to replace
...
1983-2019, averaged over 20 annually burned plots on tully soils which were not grazed by livestock [@Hartnett2019]. 
...
Additional detials of the sites and initial processing efforts are in SI section \ref{SI-Data}.
