...
between two crresponding species time series $\{ u_t, v_t\}$. In particular, 
...
of *rare* and *intermediate* categories). For
...
tail-association estimate, $A_{tot} = \sum_p (\cor_{l}-\cor_{u})$ 
can give us an idea about the overall nature of tail-asymmetry 
...
functional responses from different functional group of species within the community whereas 
synchronized fluctuation results higher $\phi_{cv}(>1)$ and makes community 
