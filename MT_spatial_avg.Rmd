...
To accomplish goal G2 of the Introduction, we will need a statistical measure of the distribution $\xtot$ that
characterizes community variability in a way that complements the classic use of $\var(\xtot)$ or $\CVcomsq$. We use
the skewness of $\xtot$. 
-Dan, give a definition, to distinguish it from the third central moment and ot make sure we are all on the same page since I think there are different definitions
-Dan, explain briefly what this measures and how it complements the usual measure
