...
We computed $\cor_l-\cor_u$ for all positively associated species (those with positive Spearman correlation); negatively associated 
...
associated species will have $\xtot$ with distinct distributional properties than will communities
...
goals G1 and G2 of the Introduction. The quantities of Fig. \ref{fig_method_box} are displayed for our 
...
tail associations. This was expected because $\CVcomsq$ depends only on species means and covariances, which were preserved 
by surrogates. The distribution, across surrogates $m=1,\ldots,M$, of the squared coefficients of variation of the quantities 
...
Because $\phi_{\text{cv}}<1$ (Fig. \ref{fig_result_box}), the conclusion via the classic 
variance ratio approach would tyically have been 
...
only the variance ratio approach to conclusions drawn using both approaches.
The combined approach yields conclusions that differ substantially from what may be concluded using solely the 
variance ratio. ...
