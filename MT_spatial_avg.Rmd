...
Second, please split Fig. 6 into 2 parts, the top part and bottom part. Please put the bottom part in the SI. Please make a version of
the top part using powerpoint, so we can edit, and either send it to me or put it in the repo (OK to commit a powerpoint in this case). 
Replace the current Fig. 6 with a pdf export of this new version, which is the top part only. You can also add the pdf export to the repo.
Don't worry about the captions. Also please make the 
changes to the top part of Fig. 6 (which will become the whole of Fig. 6) so that it looks like the drawing I have sent you, and 
so that phi_CV,ta is, instead of being indicated as being approximately 1, instead given to the same number of significant figures 
as everything else, using scientific notation if necessary. This applies to both locations where a value of phi_CV,ta is listed.
