...
showing the full picture: what if skewness changes with same variance? Fig. 1A-->


<!--p4: Following the arguments, we need an additional measure which 
could incorporate thi "skewness changing" feature of the community. Fig 1B: Box simple diagram.
...
any mechanism working in the background [?Fig 1B] that is responsible 
for changing skewness while keeping the overall correlation same? Therefore, we think may be it is "tail-association".-->
...
<!--Figs:
1A: 3 panel plot: cv same, skew = -ve, 0, +ve
1B: simple box diagram
2: pscor/tail association conceptual
3:box diagram detailed
4:corl-coru matrix plot: A. hays, B. konza
5.box diagram detailed as of fig. 3 but with filled in numbers for A. hays, B. konza.
Also show the histogram plot if needed in addition.
-->
...
\begin{figure}[!h]
\begin{center}
\textbf{ \hspace{-0.5 cm} (A)}\\
\hspace{0.5 cm}
\includegraphics[width=13cm]{./Results/pedagog_figs/pedagog_simple_cv2_skw.pdf}\\
\textbf{ \hspace{0.5 cm} (B) \hspace{5 cm} (C)}\\
\includegraphics[width=12 cm]{./Results/pedagog_figs/LTUT_rho_0.8.pdf}
\caption{Upper panel shows $(A)$ a schematic diagram of the known variance-ratio approach (on left) usually used
to assess community-stability and our proposed skewness-based analog (on right); \textit{CV} and \textit{S} denote 
...
$(B)$ stronger lower-tail and $(C)$ stronger 
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=16cm]{./Results/pedagog_figs/results_hays_knz_complex_cv2_skw.pdf}
