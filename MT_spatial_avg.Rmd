...
indication of tail association and asymmetries in tail association, as described by @Ghosh_copula (Fig. \ref{fig_pedag_taildep}).
...
measured, in aggregate for a community, by counting the number of values
$\cor_l(x_i,x_j)-\cor_u(x_i,x_j)$, for all $i \neq j$, that were positive, representing stronger lower- than
upper-tail association between species (denoted $n_L$); as well as the  number of values 
that were negative, representing stronger upper- than lower-tail association between species (denoted $n_U$).
...
cross-moment. Assuming independence of species dynamics, this is $\Sind=\frac{\sum_i m_{iii}}{(\sum_i v_{ii})^{3/2}}$.
...
<!--***DAN: Dan stopped here for now, 2020 06 12-->
...
This anticipation is consistent with the fact that upper tail 
...
two exemplary long-term community data described in Appendix \ref{SI-Data}.
...
\end{center}
\end{figure}
<!--***DAN: This figure to be replaced by a similar figure that Shyamolina is making-->
