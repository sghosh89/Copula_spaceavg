...
community stability. 
<!--new methods-->
We propose using skewness of the aggregate community property time series in an alternative 
...
To begin, we consider two simulated community dynamics datasets 
...
[@loreau2008species] (denoted $\phi_{\text{LdM}}$ on Fig. \ref{fig_pedag_cv2_skw}), which itself 
depends only on the $v_{ij}$, was also the same up to sampling variation 
...
and much less synchronous dynamics when those species common (above about 5.5); whereas in scenario 
