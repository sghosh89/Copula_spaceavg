...
@sheppard2016, @sheppard2019 and @zhao2020 developed detailed frequency-specific measures 
...
available information. The field of copula statistics [@nelsen2006_copula]
provides well-developed and general tools for assessing this detailed structure. Tail 
...
as demonstrated by our successes here. For instance, @LenseInReview indicate, in this special issue, 
that many childhood neurodevelopmental disorders are associated with deficits in 
rhythm, timing and synchrony. One wonders if diagnosis of childhood 
neurodevelopmental disorders
may eventually be improved by applying copula statistical approaches to data on synchrony
tasks attempted by patients. Whereas we are not child psychologists and cannot
critique work in that field or in the other disparate fields represented in this special issue,
the power of copula statistics and the scarcity of prior application of such tools to 
synchrony compel us to recommend these approaches to all synchrony researchers.
