...
(iii) 35 common and intermediate sp., (iv) 35 common and intermediate sp. along with the rest aggregated into 
one pseudo sp., (v) all sp. including the rare ones (for classification of species 
categories see Appendix \ref{SI-Data}). <!--(except LASP : 2014-2018 data reported only, 
need clarification from Lauren, Bare Ground)--> As a community with major lower tail dependence, JRBP was 
expected to show significantly lower skewness than symmetric "Normal" surrogates. We found the expected results with 
(i) and (iii) combinations, the rest were marginally significant because of sudden abundance of one episodic sp. 
(THSP??) in year 2017 (see Fig. \ref{SI-fig_spaceavg_timeseries}(A)). Similar results with significant lower skewness
