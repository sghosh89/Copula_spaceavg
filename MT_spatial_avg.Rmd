...
if there is, then what could we interpret about interspecific response from this
...
\includegraphics[width=8cm]{./Results/knz_results/corstat_knz_spaceavg_results/Corl-Coru_ub_0.5.pdf} 
