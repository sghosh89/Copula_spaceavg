...
within the community help us to interpret whether the total productivity is consistent 
throughout times or not [@ives1999stability]. The change in total productivity with time 
is considered as one of the proxies to quantify community-stability [@grimm1992application].
...
the other hand, arises when the majority of species fluctuate
...
Although widely used, the simple-correlation based variance ratio metric is not 
enough to predict the community-stability if the species show a stronger 
correlation among themselves for certain years than others. For example, consider
two hypothetical communities with an equal number of species. The only difference is 
...
The first community has a higher risk to collapse at once whereas the second one maintains 
high productivity throughout the years. But both communities would indicate
a similar variance ratio because it assumes equal variance between 
interspecific fluctuations throughout the years. We propose skewness instead using variance 
could be appropriate to make the distinction between two such communities. Simultaneous 
dip in the individual time series of Fig. \ref{fig_pedag_cv2_skw}A makes the 
aggregated time series more negatively skewed (Fig. \ref{fig_pedag_cv2_skw}C) whereas 
simultaneous hike in the individual time series of Fig. \ref{fig_pedag_cv2_skw}B make the 
aggregated time series more positively skewed (Fig. \ref{fig_pedag_cv2_skw}D) compared to 
...
incorporate the changing skewness feature of the community. Like variance, 
changing skewness had been used earlier as an indicator 
for changing ecosystem (i.e. for an early warning signal, regime shift, etc.) 
[@guttal2008changing; @guttal2009spatial; @dakos2010spatial; @dakos2012methods]. 
...
in JRBP: considering total percent cover time series from (i) only 23 common sp., (ii) 23 common sp. and 
...
categories see Appendix \ref{SI-Data}, Fig. \ref{SI-fig_spaceavg_time series}). As a community with major lower tail dependence, JRBP was 
...
time series of species shown in column, so the sign (or color) of the cells do not matter but 
