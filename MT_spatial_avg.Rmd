...
***DAN: Please do not use truncated values. Please use rounded values instead - this is standard scientific practice. 
Please verify that these and any other numbers that appear in two places agree, except that one could be rounded to
fewer significant figures than the other.-->
