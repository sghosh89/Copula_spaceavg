...
estimate the association between a pair of interacting species' time-series - whether 
...
between a species-pair, correlation in any part 
...
$\cor_{l}-\cor_{u}$ is considered for competing species. <!--Q. Should I tell about the direction of competition?-->
...
construct the scatter plots with the normalized rank of corresponding time-series and test their 
...
tail-asymmetry ($\cor_{l}-\cor_{u}$) as described above. For positively 
correlated species-pair, we count how many are with the stronger 
lower-tail (or upper-tail) association, $nL$ (or $nU$). These 
numbers can give us an idea about the overall nature of 
tail-asymmetry within the community.


<!--Significance tests for individual and overall asymmetry, tailsignif.R, binomial_sigtest.R-->
