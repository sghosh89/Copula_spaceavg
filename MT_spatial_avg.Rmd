...
<!--keywords-->
\noindent
Synchrony | Tail-dependence | grassland | community stability 
\linebreak
...
\caption{ Pedagogical figure showing how skewness of total biomass distribution of a community through years is
affected by asymmetric tail-dependence in individual species biomass; major lower tail dependence in a community makes 
its total biomass more negatively skewed $(A)$, whereas major upper tail dependence in a community makes 
its total biomass more positively skewed $(B)$, compared to a community having no tail-dependence.\label{fig_pedag_skewness}}
\end{center}
\end{figure}
...
RES_hays_spaceavg<-readRDS("./Results/hays_results/RES_hays_spaceavg.RDS")
```
...
On a similar note, we carried out the tail-dependence analysis for 20 most common species
(Table \ref{SI-tab_spinfo_hays}) basal cover of Hays in Kansas, as our second data set. We 
...
the community (Fig. ). We will discuss here few instances of interspecific interactions which 
we found interesting. Some dry season favorable deep rooted grasses (e.g. sp2 : ANGE, 
sp11 : PAVI2 and sp13 : PSTE5) showed upper tail dependence with synchronous abundance
(Fig. \ref{fig_LTmUT_spaceavg_hays}) whereas they were not as strongly correlated into
other moderate years (see Fig. \ref{SI-fig_hays_spaceavg_dryseasoned_grass_UTdep}). 
...
as visually evident from Fig. \ref{fig_LTmUT_spaceavg_jrg}. We counted the number of 
positively correlated cells among $23 \times 23$ multi-species interaction matrix 
and classified as $nL$ (showing more lower tail-dependence) and $nU$ (showing more upper tail dependence).
