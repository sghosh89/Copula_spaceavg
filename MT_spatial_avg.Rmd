...
8) make the thresholds used in C-F be 50-51 and 59-60 (see below on how to chose specific values). On panels E and F, 
insert two labels on each panel in the format "P=x" which give the probability of being above the higher threshold 
or below the lower threshold. Please these probabilities near on the panel to the tails of the distributions that
they give information about. Select your thresholds in such a way that there is a clear difference between the 
lower-tail probabilities on the two panels, and also between the upper-tail probabilities on the two panels.
Of course the horizontal lines on C, D should also be modified to correspond to the new thresholds. Make sure you 
choose thresholds so the time series on C goes below the lower threshold at least once, and the time series on F goes above
the upper threshold at least once.
-->
