...
\noindent \textbf{ABSTRACT.} The degree of synchrony among the population density fluctuations of multiple 
species coexisting within an ecological community is well known to have a major impact on the stability, 
though time, of aggregate measures such as the total community abundance/biomass. Synchronous or asynchronous 
(compensatory) species responses can also dictate the response of the total community to perturbations such as 
climatic changes. However, in community ecology synchrony and its influence on stability is usually measured 
...
species are both influenced by an environmental variable only when that variable exceeds a threshold. After 
reviewing the basics of the large literature on synchronous versus compensatory dynamics of species in a 
community and the consequences for ecology of such dynamics, 
<!--***DAN: The review material mentioned above is not in there currently, and needs to be added-->
...
measure of the community variability, which complements and extends standard measures. We develop a “skewness 
ratio” which quantifies the extent to which synchronous or compensatory relationships between species, and the 
asymmetry of these relationships in the tails, serve to modify community stability. The skewness ratio is analogous 
to, but complements and extends, the widely used variance ratio. Using two multi-decadal grassland datasets we 
show that taking into account asymmetric tail associations gives a new and useful viewpoint on the relationship 
between synchrony and community stability. Our theory and results constitute the beginnings of a new and more 
flexible paradigm for exploring synchronous and compensatory dynamics of species and their influence on community 
stability. Furthermore, we discuss how aspects of our approach may also lead to insights for other fields in which 
synchrony is an important phenomenon.
<!--***DAN: This last sentence also not implemented yet - do it in the Discussion, refer to other papers in the
special issue.-->
...
the skewness, $\sk(\xtot)$. The skewness of $\xtot$ is the third central moment, 
$m_3(\xtot)$, divided by the cubed standard deviation of $\xtot$. The
...
values of $\var(\xtot)$ and $\CVcomsq$. Because $\sk(\xtot)$ relates to occasional large upward
...
disaster threshold, or fall below small ones. It is the
...
for any desired number of surrogates, $M$, with properties detailed below. We used $M=10000$. Since these surrogate datasets
...
without these tail associations. Using the language of our new methods, this is the same as saying 
...
without these tail associations. This is the same as saying that for 
communities for which $n_L<n_U$ and $\Atot<0$, we should have $\Scom>\Snta$.
...
Results revealed marked differences between Hays and Konza in patterns of species tail associations. 
...
between species should also have $\xtot$ that is more left-skewed, or less right-skewed, than would have been the case
with symmetric tail associations; and that communities exhibiting more upper- than lower-tail association 
should have $\xtot$ that is more right-skewed, or less left-skewed, than would have been the case
with symmetric tail associations (Methods). We tested these hypotheses for Hays and Konza, thereby exploring the influence
of species tail associations on the distribution of $\xtot$ and addressing 
...
tail associations for community variability and thus provides and incomplete picture of the influence of species
...
across surrogates $m=1,\ldots,M$, of the squared coefficients of variation of the quantities 
$\sum_i x_i^{(m)}$ ($\CVntasq$ was defined to be the median of this distribution), was centered very 
...
compensatory, i.e., species interactions reduce or buffer against
...
and surpass high disaster thresholds is mitigated by species interactions. This new 
information agrees with and supports the old, variance-ratio-based
conclusion that species interactions are generally stabilizing at Hays, but the new information
...
compared to their lesser role in mitigating crashes. Apparently species interactions can mitigate or accentuate
...
would classically be interpreted as slightly compensatory, i.e., species interactions slightly reduce or buffer against
...
So although species interactions slightly reduce the variance of $\xtot$, they also dramatically increase right skew
...
to low values are reduced by species interactions. The variance ratio result obscures the fact that species interactions
modify extreme bahavior of $\xtot$ very differently in the two tails of its distribution. Although the variance 
ratio suggests that species dynamics at Konza are compensatory, promoting community 
stability, in fact this is not wholly true. See SI section \ref{SI-ecdf_approach} 
for related results and discussion.
...
suggesting compensatory, stabilizing species interactions. But $\phi_S$ was less than 1 for Hays 
...
species interactions in Konza are only stabilizing in that they mitigate crashes of $\xtot$. 
Interactions simultaneously accentuate explosions of $\xtot$ to high values, a feature that should probably 
...
influence of species interactions on $\sk(\xtot)$ is due to asymmetric tail associations between species. 
The influence of tail associations on the CV of $\xtot$ was negligible, as indicated 
previously, but that reflects
the inability the CV to detect the impact of tail associations rather than indicating that
tail associations are unimportant.

# Discussion\label{Discussion}

It has been known for decades that species interactions can accentuate or mitigate the 
temporal instability of an aggregate community property such as the total abundance of 
all species, through synchrony or compensatory dynamics of species. However, our overall 
results show that consequences of species interactions for community instability are more 
...
a coefficient of variation, is probably inadequate, by itself. Species interactions can actually 
...
detectable by standard approaches. In other words, species interactions can mitigate explosions of 
total abundance to high values, while simultaneously exacerbating its tendency 
to crash to low values, or vice versa. Our new skewness ratio approach combines with the variance ratio 
to reveal the more multidimensional nature of species interactions, and their correspondingly 
...
when using solely the variance ratio approach, but were revealed to differ importantly 
...
suggested, when a more nuanced approach to synchrony and compensatory dynamics is adopted.
