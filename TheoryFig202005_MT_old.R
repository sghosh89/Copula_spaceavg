...
#of tail associations on variance of a sum and the limits of that. The complete, sup
#mat version of this figure is produced by TheoryFig202005.R, and that's the definitive 
#version. This code makes a stripped down, spaced out version for the main text.
...
text(scatxlim[1],scatylim[2],"Q",adj=c(0,1))
...
text(mean(range(x)),max(range(y,yn,yr_s)),"T",adj=c(.5,1))
