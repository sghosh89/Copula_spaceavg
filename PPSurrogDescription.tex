...
each of $m$-surrogates (${m : 1, 2, \ldots, 100000}$) we computed total contribution from
...
we plotted $25^{th}$ and $75^{th}$ percentiles of the correlations for the surrogates 
along with the corresponding Pearson correlation of actual data (Fig. \ref{fig:check_pairwisecor}).
If the actual statistics lie within the confidence interval shown in Fig. \ref{fig:check_pairwisecor}, 
then the surrogates had approximately same (upto sampling variation) pairwise correlation as we assumed.
