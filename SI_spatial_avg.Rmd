...
for(isp in 1:length(id_common_sp_hays)){
  sp.screened.data[[isp]]<-data.frame(Year=c(32:72),Dat=avg_cover_over_plots_hays[,id_common_sp_hays[isp]])
...
\caption{ Timeseries plot for (A) Jasper Ridge and $(B)$ Hays data; "common" species indicate the most abundant species
