...
legend("topleft",c(paste("LTdep., skew=",round(skw_real_l,3),sep=""),paste("Normal, skew=",round(skw_surrogl,3),sep="")),lty=c(1,1),horiz=T,
...
legend("topleft",c(paste("LTdep., skew=",round(skw_real_r,3),sep=""),paste("Normal, skew=",round(skw_surrogr,3),sep="")),lty=c(1,1),horiz=T,
       col=c("black","grey"),bty="n",cex=1)
par(op)
dev.off()
```
