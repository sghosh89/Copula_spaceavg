...
all_TR<-(data_jrg_spaceavg$jrg_spaceavg_cover_byyear$TRSP$Dat+data_jrg_spaceavg$jrg_spaceavg_cover_byyear$TRTR$Dat)
...
id_TRTR<-which(names(data_jrg_spaceavg$jrg_spaceavg_cover_byyear)%in%c("TRTR","TRAL"))
data_jrg_spaceavg$jrg_spaceavg_cover_byyear<-data_jrg_spaceavg$jrg_spaceavg_cover_byyear[-id_TRTR]
