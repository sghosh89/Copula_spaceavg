...
influence of species interactions on the distribution of $\xtot$ and on probabilities that 
...
(panels A) or species interactions, generally (panels B) significantly destabilized (made more extreme) the upper tails of 
...
In other words, asymmetric tail associations (panels A) or species interactions, generally (panels B) significantly 
...
(panels A) or species interactions, generally (panels B) significantly destabilized (made more extreme) the lower tails of 
...
reveal possible stabilizing tendencies of species interactions, acting separately on the very large or small
values of $\xtot$. Thus Figs \ref{hays_ecdf} or \ref{konz_ecdf} separately reveal whether species interactions mitigate 
...
species dynamics (bottom part of Fig. \ref{hays_ecdf}B). So species interactions mitigated the severity of 
low extremes of $\xtot$, and this was due to aspects of species interactions other than tail associations.
