...
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/common_and_normal_sp_35/skewness_jrg_spaceavg_spearman_sp_35.pdf}
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/common_and_normal_sp_35/skewness_jrg_spaceavg_spearman_plotcheckon_sp_35.pdf}
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/common_and_normal_sp_35/cvsq_jrg_spaceavg_spearman_sp_35.pdf}\\
\textbf{ \hspace{0.5 cm} (J) \hspace{3.5 cm} (K) \hspace{3.5 cm} (L)} \\
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/common_and_normal_and_pseudo_sp_36/skewness_jrg_spaceavg_spearman_sp_36.pdf}
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/common_and_normal_and_pseudo_sp_36/skewness_jrg_spaceavg_spearman_plotcheckon_sp_36.pdf}
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/common_and_normal_and_pseudo_sp_36/cvsq_jrg_spaceavg_spearman_sp_36.pdf}\\
\textbf{ \hspace{0.5 cm} (M) \hspace{3.5 cm} (N) \hspace{3.5 cm} (O)} \\
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/all_sp_39/skewness_jrg_spaceavg_spearman_sp_39.pdf}
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/all_sp_39/skewness_jrg_spaceavg_spearman_plotcheckon_sp_39.pdf}
\includegraphics[width=4 cm]{./Results/jrg_results/skewness_results/all_sp_39/cvsq_jrg_spaceavg_spearman_sp_39.pdf}\\
