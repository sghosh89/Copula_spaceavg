...
saveRDS("./Results/hays_results/skewness_results/ts_mat_CP_hays.RDS")
...
<!-- model selection analysis for tail dep. with common + pseudo sp. in hays-->
...
<!-- genarating LT-UT dep. plots from model selection analysis with common + pseudo sp. in hays-->
...
<!-- non-parametric analysis for tail dep. with common + pseudo sp. in hays-->
...
<!-- genarating LT-UT dep. plots from non-parametric analysis with common + pseudo sp. in hays-->
...
<!--DAN needs to fill in the following chunk to get pearson preserving surrogates for hays with common+pseudo sp.-->
...
# you need to use set.seed(seed=....) with two seeds : surrog_seed1, surrog_seed2 (see setup chunk)
...
# result folder to save pearson preserving surrogates for hays with Common + Pseudo sp.
...
surrogs_CP_hays<-  # this is the pearson preserving surrogs as a large array for hays (Common+Pseudo sp.)
```
...
<!-- model selection analysis for tail dep. with common + pseudo sp. in knz-->
...
<!-- genarating LT-UT dep. plots from model selection analysis with common + pseudo sp. in knz-->
...
<!-- non-parametric analysis for tail dep. with common + pseudo sp. in knz-->
...
<!-- genarating LT-UT dep. plots from non-parametric analysis with common + pseudo sp. in knz-->
...
# result folder to save pearson preserving surrogates for hays with Common + Pseudo sp.
resloc_surrog_hays<-"./Results/knz_results/skewness_results/pp_surrogs_knz_CP/"
...
surrogs_CP_knz<-  # this is the pearson preserving surrogs as a large array for hays (Common+Pseudo sp.)
```
