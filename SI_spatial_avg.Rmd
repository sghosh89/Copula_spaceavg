...
```{r make_surrogs_CP_knz_t, echo=F, results="hide", warning=F, cache=T,cache.extra=list(mtime("./Results/knz_results/skewness_results/ts_CP_knz_soiltype_t.RDS"),mtime("PPSurrogObjFun.R"),mtime("pwlin.R"),mtime("getmap.R"),mtime("alignranks.R"),mtime("SurrogsForKonza_t.R"))}
...
```{r skewness_knz_spaceavg_PP, echo=F, results="hide", warning=F, cache=T, cache.extra=list(seed,surrogs_CP_KNZ_t,mtime("./Results/knz_results/skewness_results/ts_CP_knz_soiltype_t.RDS"),mtime("make_tab_stability_assessment.R"),mtime("mycvsq.R"),mtime("SkewnessAnd3CentMom.R"))}

set.seed(seed)
source("make_tab_stability_assessment.R")

ts_mat_CP_knz<-readRDS("./Results/knz_results/skewness_results/ts_CP_knz_soiltype_t.RDS")
surrogs_CP_knz<-surrogs_CP_KNZ_t
