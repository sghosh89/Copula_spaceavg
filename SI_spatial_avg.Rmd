...
legend("bottomright",c("common sp.","common + normal sp.","all sp. including rare"),lty=c(1,1,1),
...
was present maximum for 2 years. The rest are classified into "normal" category.\label{fig_spaceavg_timeseries}}
\end{center}
\end{figure}
