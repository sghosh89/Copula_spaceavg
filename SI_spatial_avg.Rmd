...
```{r plot_res_hays_npa_spaceavg, echo=F, results="hide",cache=T,warning=F, cache.extra=list(seed,corstat_hays_spaceavg,nbin_hays,mtime("NonParamStat_matrixplot.R"),mtime("mycorrplot_with_sig.R"),mtime("tailsignif.R"),mtime("CopulaFunctions_flexible.R"))}
set.seed(seed)
...
ub<-1/nbin_hays
numpts<-41 #for hays data 41years
numsims<-10000
CI<-c(0.025,0.975)
sigtest<-TRUE
...
```{r plot_res_knz_npa_spaceavg, echo=F, results="hide",cache=T,warning=F, cache.extra=list(seed,corstat_knz_spaceavg,nbin_knz,mtime("NonParamStat_matrixplot.R"),mtime("mycorrplot_with_sig.R"),mtime("tailsignif.R"),mtime("CopulaFunctions_flexible.R"))}
set.seed(seed)
source("./NonParamStat_matrixplot.R")
...
ub<-1/nbin_knz
numpts<-33 #for knz data 33years
numsims<-10000
CI<-c(0.025,0.975)
sigtest<-TRUE
