...
op<-par(mfrow=c(1,2),mar=c(3.1, 3.1, 0.5, 1.1),mgp=c(2,1,0))
plot(ccop[,1],ccop[,2],col=rgb(0,0,0,0.1),pch=20,xlab="x",ylab="y",cex.lab=1,cex.axis=1)
plot(sccop[,1],sccop[,2],col=rgb(0,0,0,0.1),pch=20,xlab="x",ylab="y",cex.lab=1,cex.axis=1)
par(op)
dev.off()
```
