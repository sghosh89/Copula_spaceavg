...
knitr::kable(tab_spinfo, 
             ...
             caption = "Information of the species considered for Jasper Ridge data; 23 most common species (highlighted) are selected based on the criterion that they are absent all over the 216 plots for not more than 6 years.\\label{tab_spinfo_jrg}", 
